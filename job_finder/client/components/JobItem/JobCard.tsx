...
function JobCard({ job, activeJob }: JobProps) {
  ...
  const companyDescription =
    "We are a leading company in our industry, committed to excellence and innovation. Join us to be part of a dynamic team that values growth and creativity.";
