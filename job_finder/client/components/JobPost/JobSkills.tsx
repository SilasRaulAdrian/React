            ...
            {skills.map((skill: string, index: number) => (
              ...
              >
                ...
                <button
                  ...
                  className="text-primary-foreground hover:text-red-500 cursor-pointer focus:outline-none"
                >
                  <X size={14} />
                </button>
              </div>
            ...
            {tags.map((tag: string, index: number) => (
              ...
              >
                ...
                <button
                  ...
                  className="text-secondary-foreground hover:text-red-500 cursor-pointer focus:outline-none"
