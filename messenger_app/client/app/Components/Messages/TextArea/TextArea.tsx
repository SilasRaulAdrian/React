  ...
  return (
    ...
    >
      <div className="relative flex-1">
        ...
        <button
          type="button"
          className="absolute top-[22px] right-3 text-[#aaa] translate-y-[-50%] text-2xl hover:cursor-pointer"
      ...
      <button
        ...
        className="px-4 self-start py-2 w-12 h-12 bg-[#7263f3] text-white rounded-full ml-2 shadow-sm hover:cursor-pointer"
      >
        {send}
      </button>
      {toggleEmoji && (
