      ...
      <div className="flex flex-col">
        ...
        >
          ...
          <div className="py-4 flex justify-end">
            <button
              type="submit"
              className="bg-[#7263f3] text-white p-2 rounded-md hover:bg-[#f56693] transition-colors duration-300 ease-in-out cursor-pointer"
            >
              Update Profile
            </button>
          </div>
        ...
        >
          ...
          <div className="py-4 flex justify-end">
            <button className="bg-[#7263f3] text-white p-2 rounded-md hover:bg-[#f56693] transition-colors duration-300 ease-in-out cursor-pointer">
              Update Password
            </button>
          </div>
        </form>
        ...
        <div className="pt-4 self-center">
          <button
            onClick={() => logoutUser()}
            className="flex items-center gap-2 bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-600 transition-colors duration-300 ease-in-out cursor-pointer"
          >
            {logout} Logout
          </button>
        </div>
