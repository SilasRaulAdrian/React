            ...
            return (
              ...
              >
                ...
                <div className="flex gap-2">
                  <button className="flex items-center justify-center h-[2.5rem] w-[2.5rem] bg-[#f56693] text-white px-4 py-2 rounded-full hover:cursor-pointer">
                    {ban}
                  </button>
                  <button
                    className="flex items-center justify-center h-[2.5rem] w-[2.5rem] bg-[#7263f3] text-white px-4 py-2 rounded-full hover:cursor-pointer"
                    onClick={() => {
                      acceptFriendRequest({
