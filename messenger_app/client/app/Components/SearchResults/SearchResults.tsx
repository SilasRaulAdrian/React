          ...
          return (
            ...
            >
              ...
              <div>
                {isFriend ? (
                  <button
                    className="flex justify-center items-center bg-[#454e56] text-white px-4 py-2 h-[2.5rem] w-[2.5rem] rounded-full hover:cursor-pointer"
                    onClick={() => {
                  ...
                  <button
                    className="flex justify-center items-center bg-[#7263f3] text-white px-4 py-2 h-[2.5rem] w-[2.5rem] rounded-full hover:cursor-pointer"
