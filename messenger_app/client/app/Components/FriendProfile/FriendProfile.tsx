  ...
  return (
    <div className="py-4 h-full flex flex-col justify-between">
      <div className="flex flex-col items-center">
        <button
          className="px-4 self-start p-1 text-2xl flex items-center gap-8 hover:cursor-pointer"
      ...
      <div className="px-4 pt-4 flex flex-col gap-2 border-t-2 border-white dark:border-[#3C3C3C]/60">
        <button className="text-red-500 font-medium self-start p-1 text-2xl grid grid-cols-[30px_1fr] items-center gap-8 hover:cursor-pointer">
