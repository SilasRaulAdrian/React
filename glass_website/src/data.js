...
const data = [
  {
    id: 1,
    description:
      "My skills encompass a wide range of technologies and tools that I have mastered over the years. From CSS3 to Adobe Cloud, Github, Linux OS, Javascript, and Python, I have honed my abilities to create efficient and effective solutions. My expertise in these areas allows me to tackle complex challenges and deliver high-quality results.",
    progress: [
      "CSS3",
      "Adobe Cloud",
      "Github",
