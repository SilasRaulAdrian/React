"use client";
import HelpSidebar from "@/app/Components/HelpSidebar";
...
function page() {
  ...
  return (
    <main>
      ...
      <div className="flex">
        <HelpSidebar />
        <div className="px-8 py-10 flex-1 flex flex-col gap-4 bg-[var(--color--bg-2)] rounded-tr-md rounded-br-md">
          {faq.map((item, index) => (
            <motion.div
              key={index}
              variants={animateY}
              ...
              className="p-4 flex flex-col gap-2 bg-[var(--color--bg-1)] border-[2px] border-[var(--color--rgba-3)] rounded-md cursor-pointer shadow-sm"
            >
