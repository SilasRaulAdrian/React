...
function AddSnippetModal() {
  ...
  return (
    <div className="fixed top-0 left-0 z-40 h-full w-full bg-[#000]/30 backdrop-blur-sm bg-opacity-50 overflow-hidden">
      <div
        ref={ref}
        className="py-5 px-6 bg-[var(--color--bg-3)] max-w-[920px] w-full flex flex-col gap-4 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg shadow-md"
      >
        <form action="" className="flex flex-col gap-4" onSubmit={handleSubmit}>
          ...
          <div className="flex justify-between gap-4">
            <div className="flex-1">
              <input
                ...
                placeholder="Title"
                className="w-full h-12 px-4 bg-[var(--color--bg-1)] text-white rounded-lg"
              />
            </div>
            <div>
              <select
                ...
                className="w-full h-12 px-4 bg-[var(--color--bg-1)] text-white rounded-lg cursor-pointer"
              >
                {languages.map((lang) => {
                  return (
          ...
          <div>
            <textarea
              ...
              className="w-full pt-2 px-4 bg-[var(--color--bg-1)] text-white rounded-lg"
              rows={2}
            ></textarea>
          </div>
            ...
            <pre>
              <code>
                <textarea
                  ...
                  className="w-full pt-2 h-[400px] px-4 bg-[var(--color--bg-1)] text-white rounded-lg"
            ...
            {tags.map((tag: ITag, index: number) => {
              return (
                <Button
                  key={index}
                  type="button"
                  className="py-1 text-white text-sm hover:cursor-pointer"
                  style={{
          ...
          <div className="flex justify-end gap-4">
            <button
              type="button"
              className="h-[47px] flex items-center justify-center px-8 bg-red-500 text-white hover:bg-red-500/80 rounded-md transition-all duration-300 ease-in-out cursor-pointer"
            ...
            <button
              ...
              } text-white hover:bg-indigo-400/90 rounded-md transition-all duration-300 ease-in-out cursor-pointer`}
              type="submit"
              style={{ fontWeight: 400 }}
            >
