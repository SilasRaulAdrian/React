...
function Snippet({ snippet, height = "400px" }: Props) {
  ...
  return (
    <div className="shadow-sm flex flex-col border-2 border-[var(--color--rgba-3)] rounded-lg">
      <div className="px-6 py-4 bg-[var(--color--bg-4)] flex items-center justify-between rounded-t-lg border-b-2 border-[var(--color--rgba-3)]">
        <Link
        ...
        <div className="flex items-center gap-2 text-gray-200">
          <button
            className="w-10 h-10 rounded-md text-green-400 text-lg flex items-center justify-center hover:cursor-pointer"
      ...
      <div className="flex-1 px-6 py-2 bg-[var(--color--bg-4)] rounded-b-lg border-t-2 border-[var(--color--rgba-3)]">
        ...
        <div className="pt-2 pb-3 flex justify-between">
          <ul className="items-start flex gap-2 flex-wrap">
            {snippet?.tags.map((tag) => {
              return (
                <li
                  key={tag._id}
                  className="tag-item px-4 py-1 border border-[var(--color--rgba-2)] text-gray-300 rounded-md cursor-pointer"
          ...
          {snippet.user?._id === userId && (
            <div className="flex gap-2">
              <button
                className="w-10 h-10 flex items-center justify-center text-blue-400 text-xl rounded-md hover:cursor-pointer"
                style={{ background: useBtnColorMemo }}
              ...
              <button
                className="w-10 h-10 flex items-center justify-center text-red-500 text-xl rounded-md hover:cursor-pointer"
                style={{ background: useBtnColorMemo }}
