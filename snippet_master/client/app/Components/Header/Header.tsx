...
function Header() {
  ...
  return (
    <div className="fixed z-20 top-0 w-full px-8 flex items-center justify-between bg-[var(--color--bg-1)] border-b-[2px] border-[var(--color--rgba-2)] h-[8vh]">
      <Link href="/" className="flex items-center gap-2">
        <Image
          ...
          className="ml-[1px]"
        />
        <h1 className="flex items-center font-bold text-white text-2xl !text-2xl !text-white">
          Snippy
        </h1>
      </Link>
      ...
      {!user._id ? (
        ...
        <div className="flex items-center gap-2">
          <button
            className="mr-4 h-[42px] px-4 flex items-center justify-center text-black bg-white rounded-lg font-semibold hover:bg-white/80 transition duration-200 ease-in-out cursor-pointer"
          ...
          <button
            ...
            className="w-[43px] h-[42px] flex items-center justify-center bg-rgba-3 rounded-lg hover:cursor-pointer"
          >
            <Image
