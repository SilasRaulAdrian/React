...
function Sidebar() {
  ...
  return (
    <div
      className={`fixed z-20 bg-[var(--color--bg-2)] h-full border-r-[2px] border-[var(--color--rgba-3)] ${
        isSidebarOpen ? "w-[15rem]" : "w-[5.2rem]"
      }`}
    >
      <span
        className="u-shadow-2 w-[45px] absolute z-50 top-[21px] right-[-47px] py-[0.8rem] bg-[var(--color--bg-1)] cursor-pointer
        ...
        {isSidebarOpen && (
          <footer className="mb-[5rem] p-4 border-t-[2px] border-rgba-3 text-gray-300">
            ...
            <p className="text-center text-sm mt-4">
              ...
              <Link href={"/"}>Silas Raul</Link>. All&nbsp;rights reserved.
            </p>
          </footer>
        )}
      </nav>
