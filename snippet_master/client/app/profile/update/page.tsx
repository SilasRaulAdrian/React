...
function page() {
  ...
  return (
    <main className="h-[90vh] relative flex justify-center items-center">
      <form
        action=""
        className="u-shadow-2 px-8 mx-8 my-8 py-6 bg-[var(--color--bg-1)] rounded-lg max-w-[1200px] w-full"
        onSubmit={(e) => {
          e.preventDefault();
      ...
      >
        <div className="flex flex-col gap-1">
          ...
          <div>
            <label
              htmlFor="file-upload"
              className="py-4 flex items-center justify-center border-2 border-dashed border-[var(--color--rgba-2)] rounded-lg cursor-pointer"
            >
              <Image
                width={100}
                height={100}
          ...
          <div className="flex-1 grid gap-4 grid-cols-[repeat(auto-fill,minmax(290px,1fr))]">
            <div className="relative w-full">
              ...
              <input
                ...
                placeholder="Github"
                className="w-full py-[.8rem] pl-[3.2rem] pr-[1rem] text-gray-200 bg-transparent border-[2px] border-[var(--color--rgba-2)] rounded-md outline-none"
              />
            </div>
          ...
          <div className="w-full mt-4 flex gap-4">
            <div className="flex-1 flex flex-col gap-1">
              ...
              <input
                ...
                className="w-full py-[.8rem] pl-4 pr-1 text-gray-200 bg-transparent border-[2px] border-[var(--color--rgba-2)] rounded-md outline-none focus:border-[#6fcf97]"
              />
            </div>
            <div className="flex-1 flex flex-col gap-1">
              <label htmlFor="name" className="text-gray-300">
          ...
          <div className="mt-4 flex flex-col gap-1">
            <div className="flex-1 flex flex-col gap-1">
              ...
              <textarea
                ...
                className="w-full py-4 pl-4 pr-1 text-gray-200 bg-transparent border-[2px] border-[var(--color--rgba-2)] rounded-md outline-none focus:border-[#6fcf97] resize-none"
              />
            </div>
        ...
        <div className="mt-6 flex gap-4 justify-end">
          ...
          <button
            ...
            hover:bg-blue-500/70 transition-all duration-300 ease-in-out cursor-pointer"
          >
            Update Profile
          </button>
        </div>
