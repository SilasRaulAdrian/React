    ...
    <div className="fixed left-0 top-0 z-50 h-full w-full bg-[#333]/30 overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            className="bg-[#F9F9F9] p-2 rounded-md border hover:cursor-pointer"
            type="date"
            name="dueDate"
            value={task.dueDate ?? ""}
        ...
        <div className="mt-8">
          <button
            type="submit"
            className={`text-white py-2 rounded-md w-full hover:bg-blue-500 transition duration-200 ease-in-out cursor-pointer ${
